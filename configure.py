...
config.libs = [
    ...
    DolphinLib(
        ...
        [
            ...
            Object(Matching, "dolphin/src/os/init/__start.c", source="dolphin/src/os/init/__start.s"),
            Object(Matching, "dolphin/src/os/init/__ppc_eabi_init.cpp", source="dolphin/src/os/init/__ppc_eabi_init.s")
        ]
    ),
    DolphinLib(
        "pad",
    ...
    trkLib(
        ...
        [
            ...
            Object(NonMatching, "debugger/embedded/MetroTRK/Portable/msg.c", mw_version="GC/1.3", cflags=cflags_trk),
            Object(NonMatching, "debugger/embedded/MetroTRK/Portable/msgbuf.c", mw_version="GC/1.3", cflags=cflags_trk),
