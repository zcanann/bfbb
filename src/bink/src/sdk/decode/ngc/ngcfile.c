...
RGBYUVTables YUVTables RAD_ATTRIBUTE_ALIGN(NGC_TABLE_ALIGNMENT) = { 0 };
...
typedef enum NGCDVDAlignment
{
    NGC_DVD_ALIGNMENT = DVD_MIN_TRANSFER_SIZE,
    NGC_DVD_ALIGN_MASK = NGC_DVD_ALIGNMENT - 1
} NGCDVDAlignment;
...
typedef enum NGCReadLayout
{
    ...
    NGC_MILLISECONDS_PER_SECOND = 1000
} NGCReadLayout;
