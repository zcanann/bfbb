...
void YUV_32mx2_4x2(u32 count)
{
    ...
    do {
        ...
        dest1[RGB_TILE_SECOND_BLOCK_WORD0] = RGB32_PAIR_HIGH(a);
        dest1[RGB_TILE_SECOND_BLOCK_WORD1] = RGB32_PAIR_HIGH(b);
        dest1[RGB_TILE_SECOND_BLOCK_NEXT_ROW_WORD0] = RGB32_PAIR_LOW(a);
        dest1[RGB_TILE_SECOND_BLOCK_NEXT_ROW_WORD1] = RGB32_PAIR_LOW(b);
