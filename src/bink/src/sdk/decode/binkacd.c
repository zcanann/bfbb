...
#define BINKAC_QUANT_INDEX_SCALE BINKAC_QUANT_INDEX_SCALE_CONST
#define BINKAC_QUANT_POWER_SCALE BINKAC_QUANT_POWER_SCALE_CONST
#define BINKAC_QUANT_POWER_BASE BINKAC_QUANT_POWER_BASE_CONST
#define BINKAC_RSQRT_NEWTON_HALF BINKAC_RSQRT_NEWTON_HALF_CONST
#define BINKAC_RSQRT_NEWTON_THREE BINKAC_RSQRT_NEWTON_THREE_CONST
#define BINKAC_TRANSFORM_ROOT_SCALE BINKAC_TRANSFORM_ROOT_SCALE_CONST
